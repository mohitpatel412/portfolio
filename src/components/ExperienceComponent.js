...
class Experience extends Component {
    render() {
        return (
<section className="text-gray-500 body-font bg-black" id="experience" style={{
              background: '#091c29'}}>

<h1 className="text-xxl font-bold justify-center pt-3 text-white">Experience</h1>
  ...
  <div className="container px-5 py-24 mx-auto flex flex-wrap">
    <div className="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
      ...
      <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        ...
        <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
          <h2 className="font-medium title-font text-gray-500 mb-1 text-xl">KIIT Robotics Society</h2>
          <p className="leading-relaxed">Web Developer</p>
          <p className="leading-relaxed">September,2020-Present</p>
        </div>
      </div>
    </div>
    <div className="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
      ...
      <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        ...
        <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
          <h2 className="font-medium title-font text-gray-500 mb-1 text-xl">IoT Lab KIIT</h2>
          <p className="leading-relaxed">Trainee Web Developer</p>
          <p className="leading-relaxed">February,2021-Present</p>
        </div>
      </div>
    </div>
  </div>
